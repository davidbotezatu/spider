...
import { ChangePassUponResetValidation } from "../validations";
import { useForm } from "react-hook-form";
import { yupResolver } from "@hookform/resolvers/yup";
import { Link, useNavigate, useParams } from "react-router-dom";

const ChangePassUponReset = () => {
  ...
  const {
    ...
    resolver: yupResolver(ChangePassUponResetValidation),
  });

  const submitForm = async (data) => {
    try {
      const formData = {
        parola: data.newPassword,
      };
...
export default ChangePassUponReset;
